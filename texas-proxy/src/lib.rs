...
/// Ensures the directory containing the running executable is at the front of
/// `PATH`, so that shells spawned inside Texas can find the `texas` binary.
pub fn register_texas_path() -> Result<()> {
