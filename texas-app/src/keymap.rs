...
pub struct KeymapPicker {
    cmd: RwSignal<Option<TexasCommand>>,
...
pub fn keymap_view(editors: Editors, common: Rc<CommonData>) -> impl View {
    ...
    let items = move || {
        ...
        let mut items = keypress
            ...
            .collect::<im::Vector<(TexasCommand, Option<KeyMap>)>>();
        ...
        items
            .into_iter()
            .enumerate()
            .collect::<im::Vector<(usize, (TexasCommand, Option<KeyMap>))>>()
    };

    let view_i18n = i18n.clone();
    let view_fn =
        move |(i, (cmd, keymap)): (usize, (TexasCommand, Option<KeyMap>))| {
            ...
            .style(move |s| {
                ...
                s.items_center()
                    ...
                    .width_pct(100.0)
                    .apply_if(i % 2 > 0, |s| {
                        s.background(config.color(TexasColor::EDITOR_CURRENT_LINE))
                    })
                    .border_bottom(1.0)
    ...
    stack((
        ...
        .style(move |s| {
            ...
            s.font_bold()
                ...
                .border_bottom(1.0)
                .border_color(config.color(TexasColor::TEXAS_BORDER))
                .background(config.color(TexasColor::EDITOR_CURRENT_LINE))
        }),
        container(
            scroll(
                virtual_stack(
