...
use texas_core::mode::{Mode, Modes};
...
use crate::{
    command::{CommandExecuted, CommandKind, TexasCommand, texas_internal_commands},
    config::TexasConfig,
    keypress::{
...
pub struct KeyPressData {
    ...
    pub commands: Rc<IndexMap<String, TexasCommand>>,
    ...
    pub commands_without_keymap: Rc<Vec<TexasCommand>>,
}

impl KeyPressData {
    pub fn new(cx: Scope, config: &TexasConfig) -> Self {
        ...
        let mut keypress = Self {
            ...
            commands: Rc::new(texas_internal_commands()),
    ...
    pub fn update_keymaps(&mut self, config: &TexasConfig) {
