...
use crate::{terminal::event::TermEvent, workspace::TexasWorkspace};
use floem::{ext_event::create_signal_from_channel, reactive::ReadSignal};
use texas_proxy::dispatch::Dispatcher;
use texas_rpc::{
...
impl CoreHandler for Proxy {
    fn handle_notification(&mut self, rpc: texas_rpc::core::CoreNotification) {
