...
pub struct TexasColor {}

impl TexasColor {
    pub const TEXAS_WARN: &'static str = "texas.warn";
    pub const TEXAS_ERROR: &'static str = "texas.error";
    pub const TEXAS_DROPDOWN_SHADOW: &'static str = "texas.dropdown_shadow";
    pub const TEXAS_BORDER: &'static str = "texas.border";
    pub const TEXAS_SCROLL_BAR: &'static str = "texas.scroll_bar";
    pub const TEXAS_TAB_ACTIVE_UNDERLINE: &'static str =
        "texas.tab.active.underline";
    pub const TEXAS_TAB_INACTIVE_UNDERLINE: &'static str =
        "texas.tab.inactive.underline";
    pub const TEXAS_ICON_ACTIVE: &'static str = "texas.icon.active";
    pub const TEXAS_ICON_INACTIVE: &'static str = "texas.icon.inactive";
