    ...
    stack((
        h_stack((
            clickable_icon_base(
                move || {
                    if open.get() {
                        TexasIcons::PANEL_FOLD_DOWN
                    } else {
                        TexasIcons::PANEL_FOLD_UP
                    }
                },
                None::<Box<dyn Fn()>>,
                || false,
        ...
        .style(move |s| {
            s.padding_horiz(10.0)
                ...
                .background(config.get().color(TexasColor::EDITOR_BACKGROUND))
        })
...
pub fn panel_container_view(
            ...
            .style(move |s| {
                ...
                s.absolute()
                    ...
                    .apply_if(is_dragging, |s| {
                        s.background(config.color(TexasColor::EDITOR_CARET))
                            .apply_if(
    ...
    .style(move |s| {
        ...
        s.apply_if(!panel.is_container_shown(&position, true), |s| s.hide())
            ...
            .color(config.color(TexasColor::PANEL_FOREGROUND))
    })
