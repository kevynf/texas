...
use crate::{language::TexasLanguage, style::SCOPES};

thread_local! {
    static HIGHLIGHT_CONFIGS: RefCell<HashMap<TexasLanguage, Result<Arc<HighlightConfiguration>, HighlightIssue>>> = Default::default();
}
